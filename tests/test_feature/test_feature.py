...
class TestExactMatchFeature:
    ...
    em_feature = ExactMatchFeature('a_attr', 'a_attr')
    ...
    def test_b_attr(self):
        ...
        assert self.em_feature.b_attr == 'a_attr'
    ...
    def test_str(self):
        ...
        assert str(self.em_feature) == 'exact_match(a_attr, a_attr)'


class TestRelDiffFeature:
    """Tests for RelDiffFeature."""

    rel_diff_feature = RelDiffFeature('a_num', 'a_num')
    ...
    def test_b_attr(self):
        """Ensure b_attr is set correctly."""
        assert self.rel_diff_feature.b_attr == 'a_num'

    def test_preprocess_output_column(self):
        """Ensure preprocess_output_column is set correctly."""
        assert self.rel_diff_feature.preprocess_output_column(True) == 'float(a_num)'
        assert self.rel_diff_feature.preprocess_output_column(False) == 'float(a_num)'
    ...
    def test_str(self):
        """Ensure __str__ returns the feature name."""
        assert str(self.rel_diff_feature) == 'rel_diff(a_num, a_num)'


class TestEditDistanceFeature:
    """Tests for EditDistanceFeature."""

    edit_distance_feature = EditDistanceFeature('a_attr', 'a_attr')
    ...
    def test_b_attr(self):
        """Ensure b_attr is set correctly."""
        assert self.edit_distance_feature.b_attr == 'a_attr'
    ...
    def test_str(self):
        """Ensure __str__ returns the feature name."""
        assert str(self.edit_distance_feature) == 'edit_distance(a_attr, a_attr)'


class TestNeedlemanWunschFeature:
    """Tests for NeedlemanWunschFeature."""

    needleman_wunsch_feature = NeedlemanWunschFeature('a_attr', 'a_attr')
    ...
    def test_b_attr(self):
        """Ensure b_attr is set correctly."""
        assert self.needleman_wunsch_feature.b_attr == 'a_attr'
    ...
    def test_str(self):
        """Ensure __str__ returns the feature name."""
        assert str(self.needleman_wunsch_feature) == 'needleman_wunch(a_attr, a_attr)'


class TestSmithWatermanFeature:
    """Tests for SmithWatermanFeature."""

    smith_waterman_feature = SmithWatermanFeature('a_attr', 'a_attr')
    ...
    def test_b_attr(self):
        """Ensure b_attr is set correctly."""
        assert self.smith_waterman_feature.b_attr == 'a_attr'
    ...
    def test_str(self):
        """Ensure __str__ returns the feature name."""
        assert str(self.smith_waterman_feature) == 'smith_waterman(a_attr, a_attr)'
