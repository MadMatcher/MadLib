...
class TestDocFreqBuilder:
    ...
    def test_init(self, tokenizer):
        ...
        builder = DocFreqBuilder('a_attr', 'a_attr', tokenizer)
        assert builder.a_attr == 'a_attr'
        assert builder.b_attr == 'a_attr'
    ...
    def test_eq(self, tokenizer):
        ...
        builder1 = DocFreqBuilder('a_attr', 'a_attr', tokenizer)
        builder2 = DocFreqBuilder('a_attr', 'a_attr', tokenizer)
